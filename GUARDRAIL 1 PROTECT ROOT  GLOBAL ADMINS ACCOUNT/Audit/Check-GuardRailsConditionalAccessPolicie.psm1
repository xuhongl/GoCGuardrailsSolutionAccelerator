...
function Check-Policy  {
    ...
    $policyState= $($Data.value).state

    $PolicyUsersAndGroupsExcluedUsers = $($Data.value).conditions.users.excludeUsers

    $PolicyUsersAndGroupsIncludedRoles = $($Data.value).conditions.users.includeRoles

    $PolicyCloudAppsIncludedApps = $($Data.value).conditions.applications.includeApplications
     
    $PolicyGrantsMFA = $($Data.value).grantControls.builtInControls
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA4Zmg14wiUCAz/
# t1i/J3AhpmgvgJLhc70vHKmr2O3kwKCCDYUwggYDMIID66ADAgECAhMzAAACU+OD
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIof
# 2M4hzIKHmTQefRtGaZiP5Pyq0NS0NMky23bLzsZrMEQGCisGAQQBgjcCAQwxNjA0
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQu
# Y29tIDANBgkqhkiG9w0BAQEFAASCAQCrFRPXQ/lk2De53pVaW8/ZOPnqYX/imTBq
# qpY2VfAw8S9eBuLV4nAuze/yRy01nXZqKoJKXcYmDTgEJgkS6GaTsBd+CLOYRnL0
# CM75vRmL4GO5muGvsw9Z9F4+c+pdmfALtULib7X330aFbaP0/hyy4Yro3Cz06akL
# mzIAPM0hCKUyuyQ0u2tAkl4ZUB5zDLr9TFI/q28swNg39z2EMgR3y8B3G4flopKg
# yaJOq0Ji3S4V9Glgn5wAiiyqZAhU8iEoPjX6tmGVZjLYIL3ZPD/MKPnDWjb3EuGk
# XduXnuEH/aO1Yxa7uh2AHs09CrJxkMlDvC9NDDPEkyPD5xHHFcIsoYIW/TCCFvkG
...
# AYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEIDtekru+ydxsR4k3HQThgpHfefVaQQiS
# vKtKnFoarpLIAgZh8D/H/wcYEzIwMjIwMTMxMDAwMDIwLjkyOFowBIACAfSggdCk
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgvI4anmwkDBXG8VRuNslUmuczdHMx4goN
# AgsZIogyLOswgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAOxVYyIv5cj0+p
...
# XoXcyEqga2FwwSIJqQDnrgizvU0vMA0GCSqGSIb3DQEBCwUABIICAEqxS3HxZRjH
# PtrsuRKtyP/mf3LSaodPeEV1owdzL+PGu2IjCS4QyGprqyShS7a3kT8qAzYlVTUj
# BlqniTuY3yIhG58LUGk2G7cAfEHMA+HHPOPBudZ1CVB6afYoWa7vG2yjoKGNyJTR
# LuvNrxUWInHEEFac6f80wiwJHJ4XszIzuiWzYtmoUO96o4kBDotPHolGp3hxtc+m
# DzNvLR8hagKajt+5cfzBKH+iKv+MrI/+YqtyEYQIis4nE46SHhHgVb0yUdYND9fE
# QHeb7kI73Rj7266gahjC/65i+BOjXYoDdUH0MGd+FlJJtJHwZus36rjkSVJ9v35k
# Rp5cf0/4+eyKD+Z0UNv9rcb+Bx/CcBvBySiNmV+Q2PiHJMNkTsywqFZHmxfBdm+l
# LItPGNiqWr1MNxEC6fYdOOeVLAgs32RjUg0XsPY7Za+rRk4KKZVBaiObKh1bX6bt
# tN+zwusNEY2e8C9jpvXcUDtc3FoZWiiziPVkjH4CHOWqx9awmcJF/VABMzNKH4co
# Uw0vNulignn/+9+yvv8um+BMuanE3oolZh6LiIg9W77kcWGcQNTOG6bwFzeTgyMO
# Nk5nSd6sBTJ7Dwfh3V0dTKI40EBKKaEIp9MhIk2VMinexmtIjvwUkLG18tw4Ulil
# 4wk1nBNgNwKnKZX2IIADbYWMyeklQUJX
