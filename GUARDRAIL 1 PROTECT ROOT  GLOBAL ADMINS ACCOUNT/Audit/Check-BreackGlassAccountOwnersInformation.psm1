...
function Get-BreakGlassOwnerinformation {
   ...
   foreach ($BGOwner in $BGOwners){
        ...
        $apiUrl=  $("https://graph.microsoft.com/beta/users/"+ $BGOwner.UserPrincipalName)
        $Data = Invoke-RestMethod -Headers @{Authorization = "Bearer $($token)"} -Uri $apiUrl
        $BGOwner.First_Name =  $Data.givenName
        $BGOwner.Last_Name =  $Data.surname
        $BGOwner.Mobile_PhoneNumber = $Data.mobilePhone
        $BGOwner.Email_address = $Data.mail
        
   }
        if((-not [string]::IsNullOrEmpty($FirstBreakGlassOwner.Email_address)) -and `
           (-not [string]::IsNullOrEmpty($FirstBreakGlassOwner.Mobile_PhoneNumber))){
                $FirstBreakGlassOwner.ComplianceStatus= $true
        } else {
            $Comments= $Comments+" "+ $FirstBreakGlassOwner.First_Name +" "+ $FirstBreakGlassOwner.Last_Name + " doesnt have either a Phone number or email address"
        }

        if((-not [string]::IsNullOrEmpty($SecondBreakGlassOwner.Email_address)) -and `
           (-not [string]::IsNullOrEmpty($SecondBreakGlassOwner.Mobile_PhoneNumber))){
                $SecondBreakGlassOwner.ComplianceStatus= $true
        } else {
             $Comments= $Comments+" "+ $SecondBreakGlassOwner.First_Name +" "+ $SecondBreakGlassOwner.Last_Name + " doesnt have either a Phone number or email address"
            }

            if($FirstBreakGlassOwner.ComplianceStatus -and $SecondBreakGlassOwner.ComplianceStatus){
                $IsCompliant= $true
            }          
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsMrelbBrk7p29
# PS/C8HlVG8QIUDzUdeF4Eoj/6nkdoqCCDYUwggYDMIID66ADAgECAhMzAAACU+OD
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJxz
# qpnh+UAGJZh5sdCL+P1UN05tRSFVVNgOt4cYjISmMEQGCisGAQQBgjcCAQwxNjA0
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEcgBpodHRwczovL3d3dy5taWNyb3NvZnQu
# Y29tIDANBgkqhkiG9w0BAQEFAASCAQBAgWG3zYWzUXxqhldQaAo6EhLZnXhEZVoh
# c+Fdi1hWT1+ekGbk04KTYsRToQmKClNvkH/R8jXqlxDkeYfpebFIIfMeUFpyAblv
# KnM0ytIYSCGJkiSBkTUz+A/iLGp4cPrb8FwfWpfs2c33NzvxePtfiA2DQTpba3YW
# pBj6hHKN5GAj3piNGL/qc2KFRefOAJPDf2ftKpFMS1cPea85+4MvSlW3PYvDxaEt
# fuWMh5o2/ecbXICZn1U/Tg4d04DItgwLXS7vl90KGLHrtUJVQz5HBdfi8MvQjQwH
# pPk0s/ztUyqOppwWwcgWd7FhSBY6IJRPzpcOTR7wdWYQgMZw7/K/oYIW/TCCFvkG
...
# AYRZCgMBMDEwDQYJYIZIAWUDBAIBBQAEICsSSVIL5yX84SNdVXHta2t05e+/KGVm
# 1zpnnrb54sQsAgZh8D/H/l8YEzIwMjIwMTMxMDAwMDA4LjU4NFowBIACAfSggdCk
...
# MjAxMDANBgkqhkiG9w0BAQUFAAIFAOWhVW8wIhgPMjAyMjAxMzEwMjIwMzFaGA8y
# MDIyMDIwMTAyMjAzMVowdDA6BgorBgEEAYRZCgQBMSwwKjAKAgU